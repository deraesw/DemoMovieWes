...
class MoviesInTheaterFactory(
        private val movieRepository: MovieRepository,
        private val movieGenreRepository : MovieGenreRepository) : ViewModelProvider.Factory {

    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if(modelClass.isAssignableFrom(MoviesInTheaterViewModel::class.java)){
            return MoviesInTheaterViewModel(movieRepository, movieGenreRepository) as T
        }
