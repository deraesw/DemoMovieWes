...
object DataTestUtils {
    ...
    val movie2Duplicate =
        Movie(id = 2, title = "movie_2_duplicate", insertDate = "10-01-2019", filterStatus = 1)
    ...
    val people1 =
        People(id = 1, name = "name_1", gender = 1, profilePath = "path", insertDate = "09-01-2019")
    val people2 =
        People(id = 2, name = "name_2", gender = 2, profilePath = "path", insertDate = "10-01-2019")
    val people2Duplicate = People(
        id = 2,
        name = "name_2_duplicate",
        gender = 1,
        profilePath = "path",
        insertDate = "10-01-2019"
    )
    val peopleList = listOf(people1, people2)
    val peopleListWithDuplicate = listOf(people1, people2Duplicate)


    val casting1 = Casting(
        id = 1,
        character = "char_1",
        peopleId = people1.id,
        movieId = movie1.id,
    ...
    val production1 = ProductionCompany(
        id = 1,
        name = "production_1",
        originCountry = "US",
        logoPath = "logo",
        insertDate = "09-01-2019"
    )
    val production2 = ProductionCompany(
        id = 2,
        name = "production_2",
        originCountry = "US",
        logoPath = "logo",
    ...
    val production2Duplicate = ProductionCompany(
        id = 2,
        name = "production_2_duplicate",
        originCountry = "BE",
        logoPath = "logo",
        insertDate = "10-01-2019"
    )
    val production3 = ProductionCompany(
        id = 3,
        name = "production_3",
        originCountry = "US",
        logoPath = "logo",
    ...
    val production4 = ProductionCompany(
        id = 4,
        name = "production_4",
        originCountry = "US",
        logoPath = "logo",
    ...
    val productionListWithDuplicate =
        listOf(production1, production2Duplicate, production3, production4)
